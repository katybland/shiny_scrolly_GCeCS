...
# This is the source code for the GCeCS shiny app on Dungeness crab HAB impacts and mitigation techniques
# code from: https://github.com/connorrothschild/shiny-scrollytell/blob/master/scripts/source_code_for_shiny.R
...
text1 <- HTML("<H2> Climate Change Fundamentals </H2>
              ...
              <br> ocean warming because ocean absorbs heat (and carbon dioxide etc)")
